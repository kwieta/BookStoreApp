...
public class BookProvider extends ContentProvider {
    ...
    static {
        ...
        // For example, "content://com.example.android.books/books/6" matches, but
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BOOK_ID:
                ...
                // For an example URI such as "content://com.example.android.books/books/7",
                ...
                // This will perform a query on the books table where the _id equals 7 to return a
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        // Check if the quantity is not null
        Integer quantity = values.getAsInteger(BookEntry.COLUMN_QUANTITY);
        if (quantity == null) {
            throw new IllegalArgumentException("Book requires quantity");
        }

        // No need to check others, any value is valid (including null).
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // check that the book title value is not null.
        ...
        // If the {@link BookEntry#COLUMN_AUTHOR} key is present,
        ...
        // check that the price value is valid (greater than 0).
        if (values.containsKey(BookContract.BookEntry.COLUMN_PRICE)) {
            // Check if the price is greater than 0 PLN
        ...
        // No need to check the number of pages, any value is valid (including null).
